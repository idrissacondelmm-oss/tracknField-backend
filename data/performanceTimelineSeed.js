...
const createTimeline = (discipline, values) => {
...
const timeline100m = createTimeline("100m", values100m);
const timeline60m = createTimeline("60m", values60m);
const timeline200m = createTimeline("200m", values200m);
const timeline400m = createTimeline("400m", values400m);
const timeline110mHaies = createTimeline("110m haies", values110mHaies);
const timeline800m = createTimeline("800m", values800m);
const timeline1500m = createTimeline("1500m", values1500m);
const timeline3000m = createTimeline("3000m", values3000m);
const timeline5000m = createTimeline("5000m", values5000m);
const timeline10000m = createTimeline("10000m", values10000m);
const timeline4x100m = createTimeline("4x100m", values4x100m);
const timeline4x400m = createTimeline("4x400m", values4x400m);
const timelineLongueur = createTimeline("Saut en longueur", valuesLongueur);
const timelineHauteur = createTimeline("Saut en hauteur", valuesHauteur);
const timelineTripleSaut = createTimeline("Triple saut", valuesTripleSaut);
const timelinePerche = createTimeline("Saut à la perche", valuesPerche);
const timelinePoids = createTimeline("Poids", valuesPoids);
const timelineDisque = createTimeline("Disque", valuesDisque);
const timelineMarteau = createTimeline("Marteau", valuesMarteau);
const timelineJavelot = createTimeline("Javelot", valuesJavelot);
const timelineDecathlon = createTimeline("Décathlon", valuesDecathlon);
const timelineHeptathlon = createTimeline("Heptathlon", valuesHeptathlon);
const timelinePentathlon = createTimeline("Pentathlon", valuesPentathlon);
const timeline10km = createTimeline("10 km", values10km);
const timelineSemiMarathon = createTimeline("Semi-marathon", valuesSemiMarathon);
const timelineMarathon = createTimeline("Marathon", valuesMarathon);

const performanceTimelineSeed = {
    "60m": timeline60m,
    "100m": timeline100m,
    "200m": timeline200m,
    "400m": timeline400m,
...
module.exports = { performanceTimelineSeed };
